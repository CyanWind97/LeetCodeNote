...
/// <summary>
/// no: 3927
/// title: 统计重新排列后包含另一个字符串的子字符串数目 I
/// problems: https://leetcode.cn/problems/count-substrings-that-can-be-rearranged-to-contain-a-string-i
/// date: 20250109
/// </summary>
public static class Solution3927
{
