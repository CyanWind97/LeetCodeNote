...
namespace LeetCodeNote
{
    ...
    /// no: 2048
    /// title: 下一个更大的数值平衡数
    /// problems: https://leetcode.cn/problems/next-greater-numerically-balanced-number/description/?envType=daily-question&envId=2023-12-09
    /// date: 20231209
    /// </summary>
    public static class Solution2048
    {
        public static int NextBeautifulNumber(int n) {
            ...
            int index = Array.BinarySearch(balance, n + 1);
            if (index < 0)
                index = ~index;
